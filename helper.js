...
module.exports.genExcel = function(filename, data, cb) {
	...
	ws.cell(1, 1).string('項次');
	ws.cell(1, 2).string('名稱');
	ws.cell(1, 3).string('貨號');
	ws.cell(1, 4).string('單價');
	ws.cell(1, 5).string('尺寸/顏色');
	ws.cell(1, 6).string('數量');
	for (var i in data) {
